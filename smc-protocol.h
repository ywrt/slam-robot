#ifndef SMC_PROTOCOL_H_
#define SMC_PROTOCOL_H_
...
enum HpmcRequest
{
    ...
    // REQUEST_GET_VARIABLES = 0x83, // duplicate define in maestro protocol
    ...
    // REQUEST_START_BOOTLOADER = 0xFF, // duplicate define in maestro protocol
};
